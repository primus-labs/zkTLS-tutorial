...
- link: https://github.com/xiafubiao/proof-of-kyc
...
This is the typical integration mode that uses Primus Network SDK and allows users to generate zkTLS attestations by themselves.
...
This is a special integration mode that requires the user's credentials, which are necessary to access the data sources, to be configured in the dapp at the backend.
Note this type of integration, developers should use Primus Network Core SDK instead.
